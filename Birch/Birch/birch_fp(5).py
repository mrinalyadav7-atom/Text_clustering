...
Original file is located at
    https://colab.research.google.com/drive/1X8UNkP8UXtQjJmh-4gJuDTSx3p02WoAO
"""
...
from sklearn.cluster import Birch
brc = Birch(branching_factor=50, n_clusters = 5, threshold=0.99)
brc.fit(x)
labels = brc.predict(x)
print(labels)

from sklearn.cluster import Birch
brc = Birch(branching_factor=30, n_clusters = 5, threshold=0.95)
brc.fit(x)
labels = brc.predict(x)
print(labels)
...
from sklearn.cluster import Birch
brc = Birch(branching_factor=100, n_clusters = 5, threshold=0.99)
brc.fit(x)
labels = brc.predict(x)
print(labels)

from sklearn.cluster import Birch
brc = Birch(branching_factor=50, n_clusters = 5, threshold=0.98)
brc.fit(x)
labels = brc.predict(x)
print(labels)

from sklearn.cluster import Birch
brc = Birch(branching_factor=50, n_clusters = 5, threshold=0.55)
brc.fit(x)
labels = brc.predict(x)
print(labels)
...
from sklearn.cluster import Birch
brc = Birch(branching_factor=50, n_clusters = 5, threshold=2)
brc.fit(x)
labels = brc.predict(x)
print(labels)
